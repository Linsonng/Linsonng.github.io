						...
						<!-- One -->
							<section id="one">
								...
								<div class="container">
									...
									<p>I am currently a college student at University College London(UCL), majoring in Computer Graphics, Vision and Imaging. My research interest focuses on computer vision (e.g., machine learning, image processing) and its applications in real-world problems.</p> 
								</div>
							</section>
							...
							<section id="two">
								<div class="container">
									...
									<ul class="feature-icons">
										<li class="icon solid fa-book">Python</li>
										<li class="icon solid fa-users">Machine Learning/ Deep Learning</li>
										<li class="icon solid fa-bolt">Image/Video/Data Processing</li>							
											...
											<table>
												...
												<tbody>
													<tr>
														...
														<td>MSc. in Computer Graphics, Vision and Imaging</td>
														<td>2022-now</td>
													</tr>
													<tr>
														<td>Beijing University of Posts and Telecommunications (BUPT)</td>
														<td>B.Eng. in Electronic Science and Technology</td>
														<td>2018-2022</td>
													</tr>
													<tr>
							...
							<section id="three">
								<div class="container">
									...
									<div class="features">
										<article>
											...
											<h5>Academic Supervisor: <br><a target="_blank" href="https://scholar.google.com/citations?user=o8PT69EAAAAJ&hl=zh-CN">Prof. Jian Cheng</a>, Dr. Chenghua Li</h5>
												...
												<p>Job Responsibilities:<br>
													...
													* Implement <b>convolutional neural network (CNN) models</b> on GPU (RTX TITAN), based on <b>Python</b> and <b>Pytorch</b>;<br>
													* Based on <b>U-Net</b>, focus on <b>real-time denoising</b> algorithm;<br>
										...
										<article>
											<a href="#" class="image"><video width="400" height="400" controls>
											...
											<div class="inner">
												...
												<p><b>Road extraction</b> is a fundamental task in the field of remote sensing which has been a hot research topic in the past decade. In the <b>CVPR DeepGlobe Road Extraction Challenge</b>, our team made Multiscale Strip Pooling DLinkNet Enhanced by Channel-wise Attention Mechanism. We also designed the fusion consisting of multiple models, including <b>ResNet, D-LinkNet, SENet, D-block, Transformer</b>, and some other new modules. The work is on the <b>3090ti</b> server using <b>PyTorch</b>. After adopting the pooling feature map to adapt the narrow-and-slender feature in road extraction tasks, we received expected improvements in IoU scores.

												Regarding this work, a patent is pending and a paper will be sent to Remote Sensing soon.</p>	
											</div>
										</article>

										<article>
											<a href="#" class="image"><img src="images/HumanData.jpg" alt="" /></a>
											<div class="inner">
												<h4>Pedestrian Classification</h4>
												<h5>01/2022 - 06/2022</h5>	
												<h5>Academic Supervisor: Dr. Da Guo, Prof. Xile Cao</h5>
												<p>My graduation project was cooperated with the engineers from <a target="_blank" href="https://www.aidong-ai.com/">Aidong Beyond Artificial Intelligence Technology (Beijing) Co., Ltd.</a> Taking advantage of the <b>private dataset of pedestrians</b> in the factory provided by Aidong, I processed real industrial datasets and completed a pedestrian classification model based on <b>ResNet</b>, in which <b>data augmentation</b> and <b>SE Module</b> are applied. The accuracy is greater than 96% (TP+TN)/<br>(TP+FN+FP+TN). Considering the needs of the industry, this project ran with <b>TensorFlow</b>.</p>	
											</div>
										</article>

										<article>
											<a href="#" class="image"><img src="images/Snowman.jpg" alt="" /></a>

											<div class="inner">
												<h4>3-D Painting Virtual Reality Platform</h4>
												<h5>02/2023 - 04/2023</h5>	
												<h5>Academic Supervisor: Prof. Anthony Steed</h5>
												<p>In cooperation with Lucien Li, I completed a <b>virtual reality</b> platform that provides the function of <b>drawing in 3D space</b> and supports <b>online multiplayer collaboration</b>. The platform is done using <b>Unity</b>, run in Unity or a VR headset. The platform is based on Ubiq, UCL's open source social virtual reality platform. On the left is the perspective of the player in the virtual environment, and another player is drawing eyes on the snowman.<!--The open source code is <a target="_blank" href="https://github.com/Linsonng/UCL-VR-2023">here</a>.--></p>	
											</div>
										</article>
